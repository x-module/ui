...
func (c *Confirm) Layout(gtx layout.Context) layout.Dimensions {
	...
	return layout.Inset{
		...
		return layout.Center.Layout(gtx, func(gtx layout.Context) layout.Dimensions {
			...
			paint.FillShape(gtx.Ops, c.theme.Palette.Bg, rc.Op(gtx.Ops))
						...
						return layout.Inset{Left: 0, Right: 10, Bottom: 10, Top: 10}.Layout(gtx, func(gtx layout.Context) layout.Dimensions {
							return layout.Stack{Alignment: layout.N}.Layout(gtx,
								layout.Stacked(func(gtx layout.Context) layout.Dimensions {
									label := material.Label(c.theme.Material(), c.theme.TextSize, c.title)
									label.Color = c.theme.Material().Palette.Fg
				...
				layout.Flexed(1, func(gtx layout.Context) layout.Dimensions {
					return layout.Flex{Axis: layout.Horizontal}.Layout(gtx,
						layout.Rigid(func(gtx layout.Context) layout.Dimensions {
							...
							but.Background = c.theme.Dark.Bg
