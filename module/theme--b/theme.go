...
func NewTheme(window *app.Window) *Theme {
	...
	t.checkBoxCheckedIcon = widget.MustIcon(widget2.NewIcon(icons.ToggleCheckBox))
	t.checkBoxUncheckedIcon = widget.MustIcon(widget2.NewIcon(icons.ToggleCheckBoxOutlineBlank))
	t.radioCheckedIcon = widget.MustIcon(widget2.NewIcon(icons.ToggleRadioButtonChecked))
	t.radioUncheckedIcon = widget.MustIcon(widget2.NewIcon(icons.ToggleRadioButtonUnchecked))
	t.chevronUpIcon = widget.MustIcon(widget2.NewIcon(icons.NavigationExpandLess))
	t.chevronDownIcon = widget.MustIcon(widget2.NewIcon(icons.NavigationExpandMore))
	t.navMoreIcon = widget.MustIcon(widget2.NewIcon(icons.NavigationMoreHoriz))
	t.navigationCheckIcon = widget.MustIcon(widget2.NewIcon(icons.NavigationCheck))
	t.dropDownIcon = widget.MustIcon(widget2.NewIcon(icons.NavigationArrowDropDown))
