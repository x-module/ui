...
func (a *MyApp) Layout1(gtx layout.Context, theme *material.Theme) layout.Dimensions {
	// 判断 editor 是否获得焦点
	if gtx.Focused(&a.Editor) {
		// editor 获得焦点时的处理
		fmt.Println("editor is focused")
		fmt.Println("editor is focused")
		fmt.Println("editor is focused")
		fmt.Println("editor is focused")
		fmt.Println("editor is focused")
	...
	return layout.Flex{Axis: layout.Vertical}.Layout(gtx,
		layout.Rigid(func(gtx layout.Context) layout.Dimensions {
			return material.Editor(a.Theme, &a.Editor, "Type here...").Layout(gtx)
		}),
	)
}
...
func (e Editor) Layout(gtx layout.Context) layout.Dimensions {
	...
	if e.IsRequired && !gtx.Focused(e.Editor) && e.Editor.Len() == 0 {
